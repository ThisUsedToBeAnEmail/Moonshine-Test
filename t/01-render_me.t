...
check_test(
    ...
    {
        ok => 1,
        name => "render element from function p: <p>test</p>",
        depth => 2,
        completed => 1,
    },
    'test render_me(p)'
...
check_test(
    ...
    {
        ok => 1,
        name => "render element: <div class=\"test\">test</div>",
        depth => 2,
    },
    'test render_me(div)'
);
...
check_test(
    ...
    {
        ok => 0,
        name => "render element from function broken: <div class=\"test\">test</div>",
        depth => 2,
